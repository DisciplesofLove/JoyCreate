...
export const geniusCoreModelsAtom = atom<LocalModel[]>([]);
export const geniusCoreModelsLoadingAtom = atom<boolean>(false);
export const geniusCoreModelsErrorAtom = atom<Error | null>(null);
