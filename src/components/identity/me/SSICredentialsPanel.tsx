...
const MOCK_CREDENTIALS: Credential[] = [
  ...
  },
  {
    ...
    subject: "did:key:zDn...terry",
    status: "active",
    issuedAt: new Date(Date.now() - 1296000000).toISOString(),
    schemaName: "Agent Creator Badge",
  },
  {
    id: "vc-3",
    type: "MarketplaceSeller",
    issuer: "did:joy:community",
    subject: "did:key:zDn...terry",
    status: "active",
    issuedAt: new Date(Date.now() - 604800000).toISOString(),
    schemaName: "Marketplace Verified Seller",
  },
  {
    id: "vc-4",
    type: "SecurityAudit",
    issuer: "did:key:zDn...auditor",
    subject: "did:joy:zQ3sh...kX7v",
    status: "expired",
    issuedAt: new Date(Date.now() - 7776000000).toISOString(),
    expiresAt: new Date(Date.now() - 2592000000).toISOString(),
    schemaName: "Security Audit Passed",
  },
];
    ...
    <div className="space-y-4 max-w-2xl">
      <Card className="bg-muted/10 border-border/30">
        ...
        <CardContent className="px-4 pb-4 space-y-3">
          ...
          <Button onClick={() => toast.success("Credential issued!")}>
            <Stamp className="w-4 h-4 mr-1" /> Issue Credential
          </Button>
        </CardContent>
      </Card>
    </div>
        ...
        <CardContent className="px-4 pb-4 space-y-3">
          <div>
            <Label className="text-xs">
              Paste Verifiable Credential (JWT or JSON-LD)
            </Label>
            <Textarea
          ...
          <div className="flex items-center gap-2">
            <Button onClick={() => toast.success("Credential verified ✅")}>
...
function SchemasTab() {
  const schemas = [
    ...
    {
      name: "Marketplace Verified Seller",
      fields: 4,
      credentials: 23,
      version: "1.1",
    },
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm">
          <Plus className="w-3.5 h-3.5 mr-1" /> Create Schema
        </Button>
      </div>
      {schemas.map((schema) => (
 ...
 * Provides its own inner sub-tabs (Credentials / Issue / Verify / Schemas).
 */
  ...
  return (
    ...
    >
      <TabsList className="bg-transparent">
        ...
        <TabsTrigger value="schemas" className="gap-1.5">
          <FileText className="w-3.5 h-3.5" /> Schemas
        </TabsTrigger>
      </TabsList>
      <div className="pt-4">
