...
export function registerAgentExportHandlers(): void {
  ipcMain.handle("agent:export:json", guarded("agent:export:json", handleExportAgentJson));
  ipcMain.handle("agent:export:standalone", guarded("agent:export:standalone", handleExportAgentStandalone));
  ipcMain.handle("agent:export:docker", guarded("agent:export:docker", handleExportAgentDocker));
  ipcMain.handle("agent:export:web-chat", guarded("agent:export:web-chat", handleExportAgentWebChat));
  ipcMain.handle("agent:export:embed-snippet", guarded("agent:export:embed-snippet", handleExportEmbedSnippet));
