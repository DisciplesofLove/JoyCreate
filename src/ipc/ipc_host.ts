...
import { registerSocialContentHandlers } from "./handlers/social_content_handlers";
import { registerSocialEngagementHandlers } from "./handlers/social_engagement_handlers";
import { registerSocialAnalyticsHandlers } from "./handlers/social_analytics_handlers";
import { registerSocialAgentHandlers } from "./handlers/social_agent_handlers";
import { registerSocialOAuthHandlers } from "./handlers/social_oauth_handlers";
...
export function registerIpcHandlers() {
  ...
  // OpenClaw Agent Command Center — aliases sessions/subagents/cron/
  // celestia/joycreate-agents channels onto existing real backends.
  // Must run AFTER agent_swarm + agent_schedule handlers because it
  // calls into them via the registered ipcMain listeners.
  registerOpenClawCommandCenterHandlers();
  ...
  registerSocialContentHandlers();
  registerSocialEngagementHandlers();
  registerSocialAnalyticsHandlers();
  registerSocialAgentHandlers();
  registerSocialOAuthHandlers();
