      ...
      models: [
        {
          ...
          capabilities: { reasoning: 98, coding: 96, creativity: 95, math: 96, multilingual: 98, factuality: 96, instruction_following: 98 },
          performance: { avgLatencyMs: 1200, tokensPerSecond: 100, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.5, outputPer1kTokens: 2.0 },
        },
        {
          id: "gpt-5.1",
          name: "GPT 5.1",
          contextLength: 400000,
          capabilities: { reasoning: 97, coding: 95, creativity: 93, math: 95, multilingual: 97, factuality: 95, instruction_following: 97 },
          performance: { avgLatencyMs: 1500, tokensPerSecond: 80, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.4, outputPer1kTokens: 1.6 },
        },
        {
          id: "gpt-5.1-codex",
          name: "GPT 5.1 Codex",
          contextLength: 400000,
          capabilities: { reasoning: 96, coding: 98, creativity: 85, math: 95, multilingual: 90, factuality: 94, instruction_following: 96 },
          performance: { avgLatencyMs: 1800, tokensPerSecond: 70, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.4, outputPer1kTokens: 1.6 },
        },
        {
          id: "gpt-5-mini",
          name: "GPT 5 Mini",
          contextLength: 400000,
          capabilities: { reasoning: 90, coding: 88, creativity: 85, math: 88, multilingual: 90, factuality: 88, instruction_following: 90 },
          performance: { avgLatencyMs: 600, tokensPerSecond: 150, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.05, outputPer1kTokens: 0.2 },
        },
      ],
    ...
    this.registerProvider({
      ...
      models: [
        ...
        },
        {
          ...
          capabilities: { reasoning: 97, coding: 97, creativity: 95, math: 93, multilingual: 96, factuality: 97, instruction_following: 98 },
          performance: { avgLatencyMs: 1100, tokensPerSecond: 95, reliability: 99, uptime: 99 },
        ...
        },
        {
          ...
          contextLength: 200000,
          capabilities: { reasoning: 99, coding: 98, creativity: 97, math: 96, multilingual: 97, factuality: 98, instruction_following: 99 },
          performance: { avgLatencyMs: 2500, tokensPerSecond: 60, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 1.5, outputPer1kTokens: 7.5 },
        },
        {
          ...
          contextLength: 1000000,
          capabilities: { reasoning: 96, coding: 96, creativity: 94, math: 92, multilingual: 95, factuality: 96, instruction_following: 97 },
        ...
        },
        {
          ...
          performance: { avgLatencyMs: 1000, tokensPerSecond: 100, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.3, outputPer1kTokens: 1.5 },
        },
      ],
      ...
      models: [
        {
          ...
          capabilities: { reasoning: 95, coding: 93, creativity: 90, math: 94, multilingual: 96, factuality: 93, instruction_following: 95 },
          performance: { avgLatencyMs: 1200, tokensPerSecond: 90, reliability: 98, uptime: 99 },
        ...
        },
        {
          ...
          name: "Gemini 3 Flash",
          contextLength: 1048576,
          capabilities: { reasoning: 90, coding: 90, creativity: 85, math: 90, multilingual: 93, factuality: 90, instruction_following: 92 },
          performance: { avgLatencyMs: 600, tokensPerSecond: 160, reliability: 98, uptime: 99 },
