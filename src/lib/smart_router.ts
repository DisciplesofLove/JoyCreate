...
export class SmartRouter extends EventEmitter {
  ...
  private async initializeDefaultProviders(): Promise<void> {
    ...
    this.registerProvider({
      ...
      type: "cloud",
      models: [
        // Current OpenAI lineup, verified 2026-09-15. Pricing is in cents per 1k
        // tokens, matching the rest of this table. gpt-5.1-codex was shut down
        // on 2026-07-23, so it is gone rather than routable.
        {
          id: "gpt-6-astra",
          name: "GPT-6 Astra",
          contextLength: 1050000,
          capabilities: { reasoning: 99, coding: 99, creativity: 97, math: 99, multilingual: 98, factuality: 98, instruction_following: 99 },
          performance: { avgLatencyMs: 2200, tokensPerSecond: 70, reliability: 99, uptime: 99 },
        ...
        },
        {
          ...
          name: "GPT-5.6 Sol",
          contextLength: 1050000,
          capabilities: { reasoning: 98, coding: 98, creativity: 95, math: 97, multilingual: 98, factuality: 97, instruction_following: 98 },
          performance: { avgLatencyMs: 1400, tokensPerSecond: 90, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.4, outputPer1kTokens: 2.0 },
        },
        {
          id: "gpt-5.6-terra",
          name: "GPT-5.6 Terra",
          contextLength: 1050000,
          capabilities: { reasoning: 95, coding: 95, creativity: 92, math: 94, multilingual: 96, factuality: 94, instruction_following: 96 },
          performance: { avgLatencyMs: 1000, tokensPerSecond: 120, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.2, outputPer1kTokens: 1.2 },
        },
        {
          id: "gpt-5.6-luna",
          name: "GPT-5.6 Luna",
          contextLength: 1050000,
          capabilities: { reasoning: 90, coding: 89, creativity: 86, math: 89, multilingual: 92, factuality: 89, instruction_following: 91 },
          performance: { avgLatencyMs: 500, tokensPerSecond: 170, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.02, outputPer1kTokens: 0.12 },
        },
      ],
    ...
    this.registerProvider({
      ...
      type: "cloud",
      models: [
        // Current Anthropic lineup, verified against Anthropic's models page
        // 2026-09-15. Cents per 1k tokens.
        {
          id: "claude-fable-5-1",
        ...
        },
        {
          ...
          capabilities: { reasoning: 100, coding: 99, creativity: 99, math: 99, multilingual: 98, factuality: 99, instruction_following: 99 },
          performance: { avgLatencyMs: 3000, tokensPerSecond: 50, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 1.0, outputPer1kTokens: 5.0 },
        },
        {
          id: "claude-opus-5",
          name: "Claude Opus 5",
          contextLength: 1000000,
          capabilities: { reasoning: 99, coding: 99, creativity: 98, math: 98, multilingual: 98, factuality: 99, instruction_following: 99 },
          performance: { avgLatencyMs: 2000, tokensPerSecond: 70, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.5, outputPer1kTokens: 2.5 },
        },
        {
          id: "claude-sonnet-5",
          name: "Claude Sonnet 5",
          contextLength: 1000000,
          capabilities: { reasoning: 97, coding: 98, creativity: 95, math: 95, multilingual: 97, factuality: 97, instruction_following: 98 },
          performance: { avgLatencyMs: 1000, tokensPerSecond: 110, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.2, outputPer1kTokens: 1.0 },
        },
        {
          id: "claude-haiku-4-5",
          name: "Claude Haiku 4.5",
          contextLength: 200000,
          capabilities: { reasoning: 90, coding: 90, creativity: 86, math: 86, multilingual: 91, factuality: 90, instruction_following: 92 },
          performance: { avgLatencyMs: 500, tokensPerSecond: 170, reliability: 99, uptime: 99 },
          pricing: { inputPer1kTokens: 0.1, outputPer1kTokens: 0.5 },
        },
      ],
    ...
    this.registerProvider({
      ...
      type: "cloud",
      models: [
        // Current Gemini lineup, verified 2026-09-15. gemini-3-pro-preview is
        // shut down. Cents per 1k tokens.
        {
          id: "gemini-3.1-pro-preview",
          name: "Gemini 3.1 Pro",
          contextLength: 1048576,
          capabilities: { reasoning: 97, coding: 96, creativity: 92, math: 97, multilingual: 97, factuality: 95, instruction_following: 96 },
          performance: { avgLatencyMs: 1400, tokensPerSecond: 90, reliability: 98, uptime: 99 },
          pricing: { inputPer1kTokens: 0.2, outputPer1kTokens: 1.2 },
        },
        {
          id: "gemini-3.8-flash",
          ...
          contextLength: 1048576,
          capabilities: { reasoning: 94, coding: 95, creativity: 88, math: 93, multilingual: 95, factuality: 92, instruction_following: 94 },
          performance: { avgLatencyMs: 600, tokensPerSecond: 170, reliability: 98, uptime: 99 },
          pricing: { inputPer1kTokens: 0.075, outputPer1kTokens: 0.375 },
        },
        {
          id: "gemini-3.5-flash-lite",
          name: "Gemini 3.5 Flash-Lite",
          contextLength: 1048576,
          capabilities: { reasoning: 86, coding: 85, creativity: 82, math: 85, multilingual: 91, factuality: 86, instruction_following: 88 },
          performance: { avgLatencyMs: 350, tokensPerSecond: 220, reliability: 98, uptime: 99 },
          pricing: { inputPer1kTokens: 0.03, outputPer1kTokens: 0.25 },
        },
        {
          id: "gemini-2.5-pro",
          name: "Gemini 2.5 Pro",
          contextLength: 1048576,
          capabilities: { reasoning: 92, coding: 90, creativity: 87, math: 92, multilingual: 95, factuality: 90, instruction_following: 92 },
